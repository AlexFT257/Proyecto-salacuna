...
export const ModalDeleteParvulo = ({setShowModalDeleteParvulo,rut,setParvulos,parvulos}) => {
    ...
    const deleteParvulo = async () => {
        try{
            ...
            if(res.status === 200){
                ...
                Swal.fire({
                    title: "Error al eliminar parvulo",
                    icon: "error",
                    confirmButtonText: "Ok",
                });
            }
            ...
            Swal.fire({
                title: "Error en la eliminacion del parvulo",
                icon: "error",
                confirmButtonText: "Ok",
            });
        }
